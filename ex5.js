...
function updateStudentGrade(studentsArray, idToUpdate, newGrade) {
  ...
  if (indexToUpdate !== -1) {
    ...
    const studentsInstance = [...studentsArray]
    // Step 3 : Update the grade of the student at the found index in the copied array.
    studentsInstance[indexToUpdate] = { ...studentsInstance[indexToUpdate], grade: newGrade }
    return studentsInstance;
  } else {
      ...
      return "The student was not found! ".studentsArray;
  }
}
